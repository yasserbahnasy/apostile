  ...
  init: function() {
    ...
    !(function() {
      ...
      document
        ...
        a
          .on("add", function i(o) {
            console.log("onAddTag: ", o.detail),
              console.log("original input value: ", e.value),
              a.off("add", i);
          })
          .on("remove", function(e) {
            console.log(e.detail),
              console.log("tagify instance value:", a.value);
          })
          .on("input", function(e) {
      ...
      (e = document.getElementById("kt_tagify_2")),
      new Tagify(e, {
        enforceWhitelist: !0,
        whitelist: [
      ...
      (function() {
        var e = document.getElementById("kt_tagify_3"),
          a = new Tagify(e);
        a.DOM.input.classList.add("form-control"),
          a.DOM.input.setAttribute("placeholder", "enter tag..."),
          a.DOM.scope.parentNode.insertBefore(a.DOM.input, a.DOM.scope);
      })(),
      (function() {
          ...
          a = new Tagify(e, {
            ...
            transformTag: function(e) {
              (e.class =
                ...
                "shit" == e.value.toLowerCase() && (e.value = "s✲✲t");
            },
            dropdown: { enabled: 3 }
          });
        a.on("add", function(e) {
      ...
      (a = document.getElementById("kt_tagify_5")),
      new Tagify(a, {
        delimiters: ", ",
        maxTags: 10,
        blacklist: ["fuck", "shit", "pussy"],
        ...
        templates: {
          dropdownItem: function(e) {
            try {
              return (
                '<div class="tagify__dropdown__item"><div class="kt-media-card">    <span class="kt-media kt-media--' +
                (e.initialsState ? e.initialsState : "") +
                '" style="background-image: url(' +
                e.pic +
                ')">        <span>' +
                e.initials +
                '</span>    </span>    <div class="kt-media-card__info">        <a href="#" class="kt-media-card__title">' +
                e.value +
                '</a>        <span class="kt-media-card__desc">' +
                e.email +
                "</span>    </div></div></div>"
              );
            } catch (e) {}
